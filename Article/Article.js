...
const article = (obj) => {
    ...
    const create = (
        ...
        if (e && selector) {
            ...
            // Add text to button if it exists
            if (selector === 'expandButton') {
    ...
    const p1 = article.append(create('p', 'date'));
    const p2 = article.append(create('p'));
    const p3 = article.append(create('p'));
